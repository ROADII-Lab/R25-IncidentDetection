...
2.  Open Code/IncidentPrediction/Incident_Prediction.Rproj - all work should be done through this .Rproj file

If a trained model has already been created, skip to step 
